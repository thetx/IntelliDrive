...
public class CarController : MonoBehaviour
{
    ...
    private void Death ()
    {
        GameObject.FindObjectOfType<GeneticManager>().Death(overallFitness, network,gameObject);
    }
    ...
    private void InputSensors() {
        ...
        Ray r = new Ray(startingPos,a);
        RaycastHit hit;

        if (Physics.Raycast(r, out hit)) {
            aSensor = hit.distance/divisor;
            // aSensor = 0.2f;
