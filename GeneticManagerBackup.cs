...
//     //Updated for Parallel Computation
//     public CarController[] controllerArray;
//     public GameObject[] carArray;
//     private int layersNum=1,neuronsNum=10;
...
//     private void Start()
//     {
//         controllerArray = new CarController[initialPopulation];
//         carArray = new GameObject[initialPopulation];
//         CreatePopulation();
//     }
...
//             carArray[i] = Instantiate(carPrefab);
//         //Updated for Parallel Computation
//         for(int i=0;i<controllerArray.Length;i++){
//             controllerArray[i] = carArray[i].GetComponent<CarController>();
//             CarController carController = controllerArray[i];
//             carController.ResetWithNetwork(population[i]);
//         }
//     }
...
//         {
//             newPopulation[startingIndex] = new NNet();
//             newPopulation[startingIndex].Initialise(layersNum,neuronsNum);
//             startingIndex++;
//         }
//     }
...
//             //updated for parallel computation
//             Child1.Initialise(layersNum, neuronsNum);
//             Child2.Initialise(layersNum, neuronsNum);
...
//             //updated for parallel computation
//             newPopulation[naturallySelected] = population[i].InitialiseCopy(layersNum, neuronsNum);
